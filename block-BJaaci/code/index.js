...
for (let movie01Genre of movies[0].genres) {
  console.log(movie01Genre);
}
// 19. Log all the genres of the second movie one by one
for (let movie02Genre of movies[1].genres) {
  console.log(movie02Genre);
}
...
for (let movie of movies) {
  console.log(movie.title === "Hannah" ? true : false);
}
