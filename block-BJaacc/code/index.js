...
/*
Yes, you can define a key of 'let of var' in any object. A key in an object in Javascript is a string and hence the meaning of let/var doesn't get invoked. The actual string is what we'll be using and therefore 'let' or 'var' or any protected keyword can be used as a key in a Javascript object.
